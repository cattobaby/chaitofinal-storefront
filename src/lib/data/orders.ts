...
export const createReturnRequest = async (data: any) => {
    ...
    const response = await fetch(
        ...
        .catch((err) => medusaError(err)) // Keep this if you want it to throw on mutation
...
// FIX: This function was causing the 500 error when it threw an exception.
// We now return an empty array [] on error so the page renders "No orders" instead of crashing.
