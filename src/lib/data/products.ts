    ...
    return sdk.client
        .fetch<{
            ...
            query: {
                ...
                offset,
                region_id: region?.id,
                // ✅ IMPORTANT: pedir variants.prices para poder mostrar moneda alternativa (USDT, etc.)
                fields:
                    "*variants.calculated_price,*variants.prices,+variants.inventory_quantity,*seller,*variants,*seller.products," +
