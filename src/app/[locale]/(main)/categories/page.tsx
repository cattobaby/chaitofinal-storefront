...
export async function generateMetadata({
    ...
    const description = `Explora todos los productos en ${
        process.env.NEXT_PUBLIC_SITE_NAME || "nuestra tienda"
    }`
    ...
    return {
        ...
        openGraph: {
            title: `${title} | ${process.env.NEXT_PUBLIC_SITE_NAME || "Tienda"}`,
            description,
            url: canonical,
            siteName: process.env.NEXT_PUBLIC_SITE_NAME || "Tienda",
            type: "website",
        },
    }
}
...
async function AllCategories({
    ...
    return (
        <main className="container">
            ...
            <h1 className="heading-xl uppercase">Todos los productos</h1>
