            ...
            return (
                <div className="flex flex-col gap-2">
                    <p className="text-negative">
                        Ocurrió un error al cargar las reseñas
                    </p>
                    <RefreshButton label="Actualizar" />
                </div>
            )
        }
                ...
                <Card>
                    <div className="text-center py-6">
                        <h3 className="heading-lg text-primary uppercase">
                            No hay reseñas escritas
                        </h3>
                        <p className="text-lg text-secondary mt-2">
                            Aún no has escrito reseñas. Cuando escribas una reseña, aparecerá
                            aquí.
                        </p>
                    </div>
                </Card>
