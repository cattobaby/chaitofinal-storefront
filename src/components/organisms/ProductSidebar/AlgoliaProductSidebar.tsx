...
function ConditionFilter({ defaultOpen = true }: { defaultOpen?: boolean }) {
    ...
    return (
        <Accordion heading="Condición" defaultOpen={defaultOpen}>
            <ul className="px-4">
...
function SizeFilter({ defaultOpen = true }: { defaultOpen?: boolean }) {
    ...
    return (
        <Accordion heading="Talla" defaultOpen={defaultOpen}>
...
function RatingFilter() {
    ...
    return (
        <Accordion heading="Calificación">
            <ul className="px-4">
                {filters.map(({ label }) => (
                    <li
                        key={label}
                    ...
                    >
                        <FilterCheckboxOption checked={isFilterActive(label)} label={label} />
